...
def minimal_toml_data():
    ...
    return {
        ...
        "memory": {
            ...
            "recall": {
                ...
                "personality": {
                    ...
                    "synthesis_prompt_narrative": "",
                    "synthesis_prompt_factual": "",
                },
            },
        ...
        "stt": {
            ...
            "audio_fail_msg": "audio transcription — failed",
        },
        "documents": {
            "enabled": True,
            "max_chars": 30000,
        ...
        "behavior": {
            ...
            "compaction": {
                ...
                "verify_enabled": True,
                "verify_max_turn_labels": 3,
                "verify_grounding_threshold": 0.5,
            },
        },
        "paths": {
