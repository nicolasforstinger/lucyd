...
class TestOpenAIBackend:
    ...
    @pytest.mark.asyncio
    async def test_api_error_propagates(self, audio_file: str) -> None:
        whisper_plugin._backend = "openai"
        mock_client = MagicMock()
        mock_client.audio.transcriptions.create = AsyncMock(
...
class TestLocalBackend:
    ...
    @pytest.mark.asyncio
    async def test_whisper_error_raises(self, audio_file: str) -> None:
        import httpx
...
class TestPreprocessAudio:
    ...
    @pytest.mark.asyncio
    async def test_transcription_failure_logged(self) -> None:
        whisper_plugin._backend = "openai"
