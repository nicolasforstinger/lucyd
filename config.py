...
Properties are auto-generated from _SCHEMA at class creation time via
_ConfigBase.__init_subclass__. ~17 custom @property methods with special
logic (env vars, path lists, fallbacks, clamping) are defined explicitly.
"""
...
#   3. A @property accessor is auto-generated by _ConfigBase.__init_subclass__
#   4. If the property needs custom logic (env vars, clamping, fallbacks),
#      add an explicit @property method in Config — it overrides the auto-gen
...
class _ConfigBase:
    """Auto-generates @property accessors for _SCHEMA entries at class creation.

    Subclass defines custom @property methods for entries that need
    special logic — those are not overwritten.
    """

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        for name, (_, typ, _) in _SCHEMA.items():
            if name in cls.__dict__:
                continue  # Preserve custom @property overrides
...
class Config(_ConfigBase):
    ...
    Schema-driven: _SCHEMA entries get auto-generated @property accessors
    via _ConfigBase.__init_subclass__. Custom @property methods handle the
    ~17 properties that need special logic (env var resolution, path list
    expansion, value clamping, cross-field fallbacks).
    """
